...
void fusionViz3D(FisheyeProcess fisheye, LidarProcess lidar, vector<double> params) {
    ...
    string pose_trans_upward_mat_path = lidar.poses_files_path_vec[lidar.spot_idx][2].pose_trans_mat_path;
    ...
    string pose_trans_downward_mat_path = lidar.poses_files_path_vec[lidar.spot_idx][0].pose_trans_mat_path;
