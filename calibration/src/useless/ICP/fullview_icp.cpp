...
//    pcl::visualization::PointCloudColorHandlerCustom <PointI> cloud_in_color_h(view25_cloud_init_trans, 20, 180, 20);
...
//    pcl::visualization::PointCloudColorHandlerCustom <PointI> cloud_dual_color_h(view50_cloud_init_trans, 180, 20, 20);
...
//    std::cout << "GICP run time: " << timer.getTimeSeconds() << " s" << std::endl;
    ...
    icp.setInputSource(view50_cloud); //设置输入点云
    ...
    icp2.setInputSource(view25_cloud); //设置输入点云
