...
int main(int argc, char** argv) {
    ...
    std::string pose_1_pcd_path = pkg_path + "/data/floor5/spot0/0/outputs/lidar_outputs/icp_cloud.pcd";
    std::string pose_2_pcd_path = pkg_path + "/data/floor5/spot0/50/outputs/lidar_outputs/icp_cloud.pcd";
